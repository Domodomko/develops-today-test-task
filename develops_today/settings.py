...
ALLOWED_HOSTS = ["localhost", "develops-today-test-task.herokuapp.com "]
...
DATABASES = {
    "default": {
        ...
        "HOST": config("POSTGRES_MAIN_DB_HOST"),
        "PORT": config("POSTGRES_MAIN_DB_PORT"),
        "NAME": config("POSTGRES_MAIN_DB_NAME"),
